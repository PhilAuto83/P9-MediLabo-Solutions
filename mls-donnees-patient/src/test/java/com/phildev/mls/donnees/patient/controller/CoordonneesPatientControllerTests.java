...
public class CoordonneesPatientControllerTests {
    ...
    public void testAvecStructureValide() throws Exception {
        when(coordonneesPatientService.getAllCoordonneesPatientByStructureId(1)).thenReturn(Arrays.asList(
                new CoordonneesPatient("2",1,"Test", "Phil", LocalDate.of(1980, Month.APRIL,12),"",""),
                new CoordonneesPatient("1",1,"Jones", "Tom", LocalDate.of(1980, Month.APRIL,12),"1 rue des tests","000-444-5555")
        ));
    ...
    public void testCoordonneesPatientAvecPatientNull() throws Exception {
        mockMvc.perform(get("/coordonneesPatient/ "))
                ...
                .andExpect(jsonPath("$.message", containsString("ne doit pas être vide ou nul")));
    }
    ...
    public void testCoordonneesPatientAvecPatientValide() throws Exception {
        when(coordonneesPatientService.getAllCoordonneesPatientById("10")).thenReturn(
                Optional.of(new CoordonneesPatient("10", 2, "James", "Lebron", LocalDate.of(1990, 5, 24), null, null)));
    ...
    public void testCreationPatientAvecObjetInvalide() throws Exception {
        CoordonneesPatient patientInValide = new CoordonneesPatient("11",null,"","", null,"","");
    ...
    public void testSuppressionAvecIdPatientValide() throws Exception {
        ...
        when(coordonneesPatientService.findById("2")).thenReturn(
                Optional.of(new CoordonneesPatient("11", 2, "VALIDE", "PATIENT", LocalDate.of(1981, 11, 1), "", "")));
