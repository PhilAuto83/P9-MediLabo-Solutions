...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler({NoteNonSupprimeeException.class, ConstraintViolationException.class, MethodArgumentNotValidException.class})
    ...
    @ExceptionHandler({NoteNonTrouveeException.class})
